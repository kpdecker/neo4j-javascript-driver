...
var Unpacker = (function () {
  ...
  _createClass(Unpacker, [{
    ...
    key: "unpackSmallInt",
    value: function unpackSmallInt(value) {
      if (this._config.preferNativeInt) {
        return value;
      } else {
        return (0, _integer.int)(value);
      }
    }
  }, {
    key: "unpackLargeInt",
    value: function unpackLargeInt(low, high) {
      if (this._config.preferNativeInt) {
        return _integer.Integer.asNative(low, high);
      } else {
        return _integer.Integer.fromBits(low, high);
      }
    }
  }, {
    key: "unpack",
